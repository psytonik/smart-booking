...
- **Notifications, revised 2026-09-23 — WhatsApp moves up, not "later."** WhatsApp confirmations/reminders ship with the pilot (Israel), alongside email — this is the acquisition/retention channel that matters there, not a nice-to-have. Telegram and mobile push stay later, once the client app exists.
...
4. **Notification channels**: turn `NotificationsService` into a channel-agnostic dispatcher (email now; **WhatsApp adapter pulled forward to the pilot**, Telegram and mobile push stay later adapters) with per-user contact details and preferences. The queue already fits this.
...
- [ ] **G7a WhatsApp notifications (pulled forward).** WhatsApp adapter on the notification dispatcher, shipped *with* the pilot, not after it — this is the primary confirmation/reminder channel for the Israel market. Telegram and mobile push stay in G7b (later).
